...
public class RetailersAdapter extends RecyclerView.Adapter<RetailersAdapter.ViewHolder> {
    ...
    @Override
    public RetailersAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.retailers_gridview_item, viewGroup, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(RetailersAdapter.ViewHolder viewHolder, int position) {
